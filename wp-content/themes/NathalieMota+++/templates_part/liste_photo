...
<div class="filters-and-sort">
    ...
    <div class="filter-list">
        ...
        $photo_format = get_terms('format');
        ?>
        <select name="format-list" id="format-filter-list">
            <option value="">Format</option>
            <?php
            if (!is_wp_error($photo_format) && !empty($photo_format)) {
                        ...
                        <div class="thumbnail-wrapper">
                            ...
                            <div class="thumbnail-overlay">
                                ...
                                <button class="fullscreen-icon" 
                                    data-src="<?php echo esc_url(wp_get_attachment_image_src(get_post_thumbnail_id(), 'large')[0]); ?>">
                                    <img src="<?php echo esc_url(get_template_directory_uri() . '/img_logo/Icon_fullscreen.png'); ?>" alt="Icône de plein écran" class="fullscreen-trigger">
                                </button>
